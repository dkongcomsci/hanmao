...
/**
 * ช่วงเวลาที่สมาชิกอยู่ในกลุ่ม คำนวณเป็น ms เทียบกับหน้าต่างเวลาของบิล
 ...
 *    ถ้าผูกทิศทาง คู่ที่พลิกจะได้ key ใหม่ → ติ๊กหลุด → กล่อง "จ่ายครบทุกคนแล้ว" กับปุ่มปิดกลุ่มหายเอง
 ...
 * = ติ๊กชุดเดิมเป็นโมฆะ ต้องติ๊กใหม่บน "ยอดปิดจริง" ก่อนปิดกลุ่ม (ตาข่ายกันเงินหายชั้นสุดท้าย)
 *
 ...
 * (ปกติคือคนที่ควักเงินให้กลุ่มมากที่สุด → ทิศทางที่ได้ตรงกับที่คนคาด: ทุกคนโอนคืนคนที่ออกเงิน)
 ...
 *   -> ติ๊ก "โอนแล้ว" ของคู่ที่หายไปหลุด -> กล่อง "จ่ายครบทุกคนแล้ว" และปุ่มปิดกลุ่มหายเอง
 *   ศูนย์กลางเลือกจากข้อมูล (settleHub) ไม่ใช่จากยอดปัจจุบัน -> ชุดคู่โอนนิ่งตลอดกลุ่ม
 *   ต้นทุน: รายการโอนอาจมากกว่า greedy 1 รายการในกลุ่มที่มีเจ้าหนี้หลายคน (วัดได้ +0.4%)
 *
